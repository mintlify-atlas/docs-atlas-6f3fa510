...
The RemotePlugin (exported as `useRemoteData`) is a minimal hook for managing remote data state with SeizenTable. It handles loading states, errors, and cursor-based pagination while keeping pagination, sorting, and filtering logic in the table itself.
